module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        caption: '"Inter Tight"',
        "caption-bold": '"Inter Tight"',
        body: '"Inter Tight"',
        "body-bold": '"Inter Tight"',
        "heading-3": '"Inter Tight"',
        "heading-2": '"Inter Tight"',
        "heading-1": '"Inter Tight"',
        "monospace-body": '"Inter Tight"',
      },
      boxShadow: {
