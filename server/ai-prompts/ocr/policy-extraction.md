...
- **Talnormalisering (DKK)**:
  - **KRITISK DANSK FORMAT**: I Danmark betyder punktum (.) tusindtalsseparator og komma (,) decimal
  - **Parsing-regel**: Fjern ALLE separatorer (punktum, mellemrum, apostrof), derefter erstat komma med punktum, så parse
  - **Eksempler**: 
    - "5.682,13 kr" → fjern separatorer → "5682,13" → erstat komma → "5682.13" → parse til 5682.13
    - "3.154,04 kr" → fjern separatorer → "3154,04" → erstat komma → "3154.04" → parse til 3154.04
    - "3 154,04 kr" → fjern separatorer → "3154,04" → erstat komma → "3154.04" → parse til 3154.04
